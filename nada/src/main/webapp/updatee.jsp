...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update professeur set sname = ?,datedenaissance = ?,adresse= ? ,telephone= ? where id = ?");
            ...
            <div class="col-sm-4">
                <form  method="POST" action="#" >
                    ...
                    <%    
                        ...
                        pst = con.prepareStatement("select * from professeur where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
