...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update postule set sname = ?,datedenaissance = ?,adresse= ? ,telephone= ? where id = ?");
...
<html>
    <head>
        ...
        <title>Modification postule</title> 
            ...
            <div class="col-sm-4">
                <form  method="POST" action="#" >
                    ...
                    <%    
                        ...
                        pst = con.prepareStatement("select * from postule where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    %>
                    <div alight="left">
                        <label class="form-label">Nom postule</label>
                    ...
                    <% }  %>
                     ...
                     <div alight="right">
                         ...
                         <div align="right">
                             ...
                             <p><a href="indexp.jsp">Retour</a></p>
