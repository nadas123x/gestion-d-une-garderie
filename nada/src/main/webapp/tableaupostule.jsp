    ...
    try {
        ...
        if (res.next()) {
            do {
                ...
                String contact_id = res.getString(1);
                String first_name = res.getString(2);
                String last_name = res.getString(3);
                String poste = res.getString(5);

                String url = res.getString(5);

out.print( "<table> <thead><tr><th>Nom complet élève</th><th>Nom complet parent</th><th>Adresse parent</th><th>Téléphone</th><th>id</th></tr></thead><tbody><tr><td>"+contact_id+ " </td><td>"+ first_name + "</td><td>" + last_name + "</td><td>"  + poste + "</td></tr></tbody> </table>");
            } while (res.next());
